...
/**
 * **Feature: openapi-docs, Property 1: Zod to OpenAPI Schema Transformation**
 * *For any* Zod schema with OpenAPI extensions, the generated OpenAPI schema
 * SHALL contain all properties with their correct types, descriptions, and examples.
 * **Validates: Requirements 1.1, 4.1**
 */
describe("OpenAPI Schema Transformation", () => {
  // 프로퍼티 이름 생성기
  ...
  it("should preserve property descriptions in generated schema", () => {
    fc.assert(
      fc.property(
        propertyNameArb,
        descriptionArb,
  ...
  it("should preserve example values in generated schema", () => {
    fc.assert(
  ...
  it("should correctly map Zod types to OpenAPI types", () => {
    const registry = new OpenAPIRegistry();
